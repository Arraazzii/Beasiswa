...
<div class="col-md-4 col-lg-4" >
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right" height="50px"><input style="height:35px; float:right; margin-top:5px;" type="submit" value="Cari" class="btn btn-warning">
    <input style="height:35px; float:right; margin-top:5px;" type="button" value="Refresh" class="btn btn-warning" onclick="window.location.href='index.php?conten=in_hawa'"> </td>
  </tr>
</table>
   </td>
  </tr>
...
<div class="table-responsive">
  ...
  <?php
    ...
    $result = mysql_query("SELECT a.nin, a.nama, a.tgl_la, a.kab, a.prov, b.nama_sekolah, b.kab, b.prov, a.email FROM data_pendaftar AS a, data_sekolah AS b WHERE a.nin = b.nin AND a.nin LIKE '%".$nisn."%' AND a.nama LIKE '%".$nama."%' ");  
...
<!--     <div class="form-group">
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-primary" onclick="proses_wawan()">Simpan</button>
