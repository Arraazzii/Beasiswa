...
<div class="table-responsive">
  ...
  <?php
 	$i=1;
    $result = mysql_query("SELECT a.nin, a.nama, a.tgl_la, a.kab, a.prov, b.nama_sekolah, b.kab, b.prov, a.email FROM data_pendaftar AS a, data_sekolah AS b WHERE a.nin = b.nin ");  
