...
if ($nilai_wa1[3]<=$nil_1 &&  $nilai_wa1[4]>=$nil_1){
    $ponit_wa1 = 40; 
}
if ($nilai_wa1[5]<=$nil_1 &&  $nilai_wa1[6]>=$nil_1){
    $ponit_wa1 = 60; 
}
if ($nilai_wa1[7]<=$nil_1 &&  $nilai_wa1[8]>=$nil_1){
    $ponit_wa1 = 80; 
}
...
if ($nilai_wa2[3]<=$nil_2 &&  $nilai_wa2[4]>=$nil_2){
    $ponit_wa2 = 40; 
}
if ($nilai_wa2[5]<=$nil_2 &&  $nilai_wa2[6]>=$nil_2){
    $ponit_wa2 = 60; 
}
if ($nilai_wa2[7]<=$nil_2 &&  $nilai_wa2[8]>=$nil_2){
    $ponit_wa2 = 80; 
}
...
if ($nilai_wa3[3]<=$nil_3 &&  $nilai_wa3[4]>=$nil_3){
    $ponit_wa3 = 40; 
}
if ($nilai_wa3[5]<=$nil_3 &&  $nilai_wa3[6]>=$nil_3){
    $ponit_wa3 = 60; 
}
...
if ($nilai_wa4[3]<=$nil_4 &&  $nilai_wa4[4]>=$nil_4){
    $ponit_wa4 = 40; 
}
if ($nilai_wa4[5]<=$nil_4 &&  $nilai_wa4[6]>=$nil_4){
    $ponit_wa4 = 60; 
}
...
if ($nilai_wa5[3]<=$nil_5 &&  $nilai_wa5[4]>=$nil_5){
    $ponit_wa5 = 40; 
}
if ($nilai_wa5[5]<=$nil_5 && $nilai_wa5[6]>=$nil_5){
    $ponit_wa5 = 60; 
}
