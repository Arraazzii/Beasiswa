...
<center><h3> Pengumuman Wawancara </h3></center>
<hr>
<div id="hasil_cari_data">
  <div style="padding-left: 20%;padding-right: 20%;">
  <form class="form-horizontal" method="post" action="index.php?conten=penguwa_in&add" id="myForm" name="myForm" onsubmit="return validateForm()" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <tr>
    ...
    <span>Dokumen</span>
   <textarea class="form-control" rows="15" cols="200" id="dokumen" name="dokumen"></textarea>
