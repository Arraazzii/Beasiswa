...
<br>
<center>
<a href="index.php?conten=data_hawa"><button type='button' class='btn btn-warning'><span class="glyphicon glyphicon-chevron-left"></span> Kembali</button></a>
</center>
<style type="text/css">
  #nomer{
    width: 70%;
...
<ul class="nav nav-tabs">
  ...
  <li><a data-toggle="tab" href="#menu4">E. NILAI WAWANCARA</a></li>
</ul>
...
<img height="400px" width="400px" src="../../img/profil/<?php echo $hh['17']; ?>" >
  ...
  <tr>
   ...
   <tr>
    ...
    <input type="text" name="nama_sek" id="nama_sek" class="form-control" value="<?php echo $hh['37']; ?>" disabled >
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">No Pokok Statistik Nasional</font></label>
    <input type="text" name="npsn" id="npsn" class="form-control" value="<?php echo $hh['38']; ?>" disabled  >
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Alamat Sekolah</font></label>
    <input type="text" name="alamat_sek" id="alamat_sek" class="form-control" value="<?php echo $hh['39']; ?>" disabled >
    </td>
    </tr>
    <tr>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Kecamatan</font></label>
    <input type="text" name="kec_sek" id="kec_sek" class="form-control" value="<?php echo $hh['40']; ?>" disabled >
    </td>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Kabupaten</font></label>
    <input type="text" name="kab_sek" id="kab_sek" class="form-control" value="<?php echo $hh['41']; ?>" disabled >
    </td>
   </tr>
  <tr>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Provinsi</font></label>
    <input type="text" name="prov_sek" id="rov_sek" class="form-control" value="<?php echo $hh['42']; ?>" disabled >
    </td>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Kode Pos :</font></label>
    <input type="text" name="pos_sek" id="pos_sek" class="form-control"  value="<?php echo $hh['43']; ?>" disabled>
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Telepon Sekolah</font></label>
    <input type="text" name="telp_sek" id="telp_sek" class="form-control" value="<?php echo $hh['44']; ?>" disabled >
    </td>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Fax Sekolah :</font></label>
    <input type="text" name="fax_sek" id="fax_sek" class="form-control" value="<?php echo $hh['45']; ?>" disabled >
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Email Sekolah</font></label>
    <input type="text" name="email_sek" id="email_sek" class="form-control"  value="<?php echo $hh['46']; ?>" disabled>
    </td>
    </tr>
    <tr>
    <td  id="warnaabutua"></td>
  ...
  <tr>
   ...
   <tr>
    ...
    <input type="text" name="nama_ortu" id="nama_ortu" class="form-control" value="<?php echo $hh['48']; ?>" disabled>
    </td>
   </tr>
    <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Pekerjaan Orang Tua</font></label>
    <input type="text" name="peker_ortu" id="peker_ortu" class="form-control" value="<?php echo $hh['49']; ?>" disabled>
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Alamat Tinggal Orang Tua</font></label>
    <input type="text" name="alamat_ortu" id="alamat_ortu" class="form-control" value="<?php echo $hh['50']; ?>" disabled>
    </td>
   </tr>
    <tr>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Kecamatan</font></label>
    <input type="text" name="kec_ortu" id="kec_ortu" class="form-control" value="<?php echo $hh['51']; ?>" disabled >
    </td>
    <td class="bgisitabel" align="left">
    <label for="exampleInputEmail1"><font color="#FFF">Kabupaten</font></label>
    <input type="text" name="kab_ortu" id="kab_ortu" class="form-control" value="<?php echo $hh['52']; ?>" disabled >
    </td>
   </tr>
  <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Provinsi</font></label>
    <input type="text" name="prov_ortu" id="prov_ortu" class="form-control" value="<?php echo $hh['53']; ?>" disabled >
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Telepon Orang Tua</font></label>
    <input type="text" name="telp_ortu" id="telp_ortu" class="form-control"  value="<?php echo $hh['54']; ?>" disabled>
    </td>
    </tr>
    <tr>
    <td  id="warnaabutua"></td>
  ...
  <tr>
   ...
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Nilai Wawancara 1</font></label>
    <input type="text" name="nama_ortu" id="nama_ortu" class="form-control" value="<?php echo $hh['30']; ?>" disabled>
    </td>
   </tr>
    <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Nilai Wawancara 2</font></label>
    <input type="text" name="peker_ortu" id="peker_ortu" class="form-control" value="<?php echo $hh['31']; ?>" disabled>
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Nilai Wawancara 3</font></label>
    <input type="text" name="alamat_ortu" id="alamat_ortu" class="form-control" value="<?php echo $hh['32']; ?>" disabled>
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Nilai Wawancara 4</font></label>
    <input type="text" name="alamat_ortu" id="alamat_ortu" class="form-control" value="<?php echo $hh['33']; ?>" disabled>
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Nilai Wawancara 5</font></label>
    <input type="text" name="alamat_ortu" id="alamat_ortu" class="form-control" value="<?php echo $hh['34']; ?>" disabled>
    </td>
   </tr>
 ...
 <tr>
    ...
    <input type="text" name="rapot" id="rapot" class="form-control"  value="<?php echo $hh['25']; ?>" disabled>
    </td>
   </tr>
   <tr>
    <td class="bgisitabel" align="left" colspan="2">
    <label for="exampleInputEmail1"><font color="#FFF">Nilai Rata - Rata Angka Raport Katerampilan</font></label>
     <input type="text" name="rapot_ket" id="rapot_ket" class="form-control"  value="<?php echo $hh['26']; ?>" disabled>
...
<tr>
  ...
  <tr>
    ...
    <input type="text" name="rapot" id="rapot" class="form-control"  value="<?php echo $hh['28']; ?>" disabled>
    </td>
   </tr>
  <tr>
