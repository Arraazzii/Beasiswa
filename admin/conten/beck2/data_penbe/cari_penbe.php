...
<center><h3>Data Rekapitulasi</h3>
  <p>&nbsp;</p>
</center>
<hr>
<div class="col-md-5 col-lg-5" >
 ...
 <form method="POST" action="index.php?conten=cari_penbe">
  ...
  <tr>
    <td width="180"></td>
    <td align="right"><input style="height:35px; float:right; margin-top:5px;" type="button" value="Refresh" class="btn btn-warning" onclick="window.location.href='index.php?conten=data_penbe'">
...
data_sekolah AS b
WHERE
a.nin = b.nin AND a.st_admis = 'Y' AND a.st_wawan = 'Y'  AND a.no_beasiswa = '".$id_daf."' AND YEAR(a.tgl_daftar) = '".$th_daf."' ");	 
    ...
    <td bgcolor=\"$bg\" class='na'>$view_per[8]</td>
    <td bgcolor=\"$bg\" class='na'>$view_per[9]</td>
	<td bgcolor=\"$bg\">";
	?>
   <?php
   if($view_per[10]=='Y'){ 
  ...
  <tr>
    ...
    <tr>
    <td colspan="9"></td>
       <td  colspan="2" align="center" id="BG_menu_data_Calon_Penerima" style="padding-top:10px"><button type="button" class="btn btn-warning" onclick="simpan()">&nbsp;Export Excel&nbsp;</button></td>
     </tr>
