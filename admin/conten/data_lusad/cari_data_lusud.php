...
<center><h3> Data Lulus Administrasi</h3>
  <p>&nbsp;</p>
</center>
<hr>
<div class="col-md-4 col-lg-4" >
  <div class="table-responsive">
  <form method="POST" action="index.php?conten=cari_lusad">
...
FROM
data_pendaftar where st_admis = 'Y' ");  
          while ($row_nomer = mysql_fetch_array($result_nomer))  
          {
            echo"<option value='$row_nomer[0]'>$row_nomer[0]</option>";
          }  
  ...
  <tr>
    ...
    <input style="height:35px; float:right; margin-top:5px;" type="button" value="Refresh" class="btn btn-warning" onclick="window.location.href='index.php?conten=data_lusad'"></td>
  </tr>
</table>
   </td>
  </tr>
...
<div class="table-responsive">
  ...
  <tr>
   <td width="2%"  valign="middle" align="center" class="lekukantabel1" id="warnaabutua">No</td>
    ...
    <td width="7%" id="warnaabutua" >Nilai Administrasi</td>
    <td width="8%" id="warnaabutua" >Status Administrasi</td>
    <td width="10%" id="warnaabutua" colspan="2" align="center" class="lekukantabel2">Detail</td>
  </tr>
  <?php 
 if(isset($_POST['id_daf'])){
        $id_daf = $_POST['id_daf'];
    }else{
        $id_daf ='';
    }
     if(isset($_POST['th_daf'])){
        $th_daf = $_POST['th_daf'];
    }else{
        $th_daf ='';
    }
...
data_sekolah AS b
WHERE
a.st_admis = 'Y' AND a.nin = b.nin AND YEAR(a.tgl_daftar) = '$th_daf' AND a.no_beasiswa = '$id_daf' ORDER BY  a.nama
");
...
while ($qq= mysql_fetch_array($q)) {
 ...
 echo " <tr style='background-color: #FFFFFF'>
    ...
    <a href='index.php?conten=detail_lusad&id=".$qq['0']."'><button class='btn btn-warning'> View</button></a>
    </td>
    <td align='left' bgcolor=\"$bg\">
    <form action='data_lusad/pendaftaran_export_excel.php' method='post'>
 ...
 <tr><td></td></tr>
    ...
    <td colspan="9"></td>
       ...
       <form action="data_lusad/pendaftaran_export_excel_all.php" method="post">
