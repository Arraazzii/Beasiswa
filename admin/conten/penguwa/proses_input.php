...
//tujuan
$q = mysql_query("SELECT nin,email FROM data_pendaftar WHERE st_wawan = 'Y'  AND YEAR(tgl_daftar) = '$tahun' AND no_beasiswa = '$nomer'");
...
<?php  } else { 
 $qry="INSERT INTO `pengumuman_wawan` (`no_beasiswa`, `tahun`, `judul`, `tgl`, `file`) VALUES ('$nomer', '$tahun', '$judul', '$tgl', '$dokumen')";
    $data=mysql_query($qry) or die(mysql_error());
    ?>
    <script language="javascript"> 
    document.location.href="?conten=penguwa";
</script><?php  
  }
?>