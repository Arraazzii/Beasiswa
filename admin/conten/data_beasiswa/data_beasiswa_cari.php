...
<div class="col-md-5 col-lg-5" >
  ...
  <tr>
    ...
    <input style="height:35px; float:right; margin-top:5px;" type="submit" value="Cari" class="btn btn-warning">
     <input style="height:35px; float:right; margin-top:5px;" type="button" value="Refresh" class="btn btn-warning" onclick="window.location.href='index.php?conten=data_bea'">
  </tr>
</table>
   </td>
  </tr>
...
<div class="table-responsive">
  ...
  <?php 
  $id_bea = $_POST['id_bea'];
  $tahun_bea = $_POST['th_bea'];
$result = mysql_query("SELECT * FROM info_beasiswa WHERE no_beasiswa = '".$id_bea."' AND tahun = '".$tahun_bea."' ");  
$i=0;
