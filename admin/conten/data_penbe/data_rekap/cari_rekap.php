...
<div class="col-md-5 col-lg-5" >
 ...
 <form method="POST" action="index.php?conten=cari_rekap">
...
data_sekolah AS b
WHERE
a.nin = b.nin  AND a.no_beasiswa = '".$id_daf."' AND YEAR(a.tgl_daftar) = '".$th_daf."' ");	 
	...
	?>
   <?php
   if($view_per[10]=='Y' && $view_per[20]=='Y'){ 
      $st = 'Lulus';
    }else{ 
      $st = 'Tidak Lulus';
    }
  ...
  <tr>
    ...
    <td colspan="9"></td>
       <td  colspan="2" align="center" id="BG_menu_data_Calon_Penerima" style="padding-top:10px">
          <form action="data_rekap/rekap_export_excel.php" method="post">
