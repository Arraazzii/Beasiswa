...
<center><h3>Data Penerima Beasiswa</h3>
  <p>&nbsp;</p>
</center>
<hr>
  ...
  <tr>
    ...
    <td colspan="9"></td>
       <td  colspan="2" align="center" id="BG_menu_data_Calon_Penerima" style="padding-top:10px">
          <form action="data_penbe/penbe_export_excel.php" method="post">
          <input type="hidden" name="no_cari" value="<?php echo $id_daf;?>" class="btn btn-warning">
          <input type="hidden" name="tahun_cari" value="<?php  echo $th_daf;?>" class="btn btn-warning">
