  ...
  <tr>
    ...
    <td width="30%">
        <select name="kategori" id="kategori" style="color:#000; width:100%;" class="form-control">
            <option value="lokasi_nama">Nama Provinsi</option>
            <option value="lokasi_kode">Kode Provinsi</option>
        </select>
    </td>
  </tr>
  <tr>
...
<div class="table-responsive">
  ...
  <?php
 	$i=1;
    $result = mysql_query("SELECT lokasi_ID, lokasi_kode, lokasi_nama, st, lokasi_propinsi FROM inf_lokasi where lokasi_kabupatenkota = 0 AND lokasi_kecamatan = 0 AND lokasi_kelurahan = 0 ORDER BY lokasi_nama ");
...
{  
  ...
  <a href=\"index.php?conten=kab&data=$row[4]\"><button type=\"button\" class=\"btn btn-info btn-lg\">Kabupaten</button></a>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><b>Data Provinsi</b></h4>
        </div>
        <!-- body modal -->
...
<div id="myModal_input" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Tambah Data Provinsi</b></h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
        <div class="col-xs-12" style="padding-bottom: 10px;">
  ...
  <div id="myModal_del" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Hapus Data Provinsi</b></h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
        <div class="col-xs-12" style="padding-bottom: 10px;">
...
<script type="text/javascript">
  ...
  /*alert('tampil');*/
    ...
    var indi = 'cari';
    var url_all = $('#url').val();
    var url = url_all+'daerah/proses_daerah.php';
   // alert(url);
...
/*alert(nama_data_in+','+st_data_in);*/
 $.getJSON(url, { nama_data_in : nama_data_in, st_data_in : st_data_in, indi : indi }, function(data) {
  var stringBaru = data.split("-");
      //alert(stringBaru[0]);
      var stringid = stringBaru[1].split(".");
       tampung = "<tr  style='background-color: #FFFFFF'><td class='id' bgcolor='"+warna+"' align='center'>"+jumlah+"</td><td class='nisn' bgcolor='"+warna+"'>"+stringBaru[1]+"</td><td bgcolor='"+warna+"' class='nama'>"+nama_data_in+"</td><td bgcolor='"+warna+"' align='center' class='st'>"+st+"</td><td bgcolor='"+warna+"' align='center'><a href='index.php?conten=kab&data="+stringid[0]+"'><button type='button' class='btn btn-info btn-lg'>Kabupaten</button></a><button type='button' class='btn btn-info btn-lg' data-toggle='modal' data-target='#myModal_del' onclick='view_del($(this))'>Delete</button><button type='button' class='btn btn-info btn-lg' data-toggle='modal' data-target='#myModal' onclick='wawan($(this))'>Edit</button></td></tr>";
        $('#nomernya').val(jumlah); 
