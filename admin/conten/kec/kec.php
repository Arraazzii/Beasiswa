  ...
  <tr>
    ...
    <td width="30%">
        <select name="kategori" id="kategori" style="color:#000; width:100%;" class="form-control">
            <option value="lokasi_nama">Nama Kecamatan</option>
            <option value="lokasi_kode">Kode Kecamatan</option>
        </select>
    </td>
  </tr>
  <tr>
...
<div class="table-responsive">
  ...
  <tr>
    ...
    <td width="10%" valign="middle" id="warnaabutua">Id Kecamatan</td>
    <td width="55%" id="warnaabutua">Nama Kecamatan</td>
  ...
  <?php
 	$i=1;
    $result = mysql_query("SELECT lokasi_ID, lokasi_kode, lokasi_nama, st, lokasi_propinsi, lokasi_kabupatenkota FROM inf_lokasi where lokasi_propinsi = '".$data."' AND lokasi_kabupatenkota = '".$data2."'  AND lokasi_kecamatan != 0 AND lokasi_kelurahan = 0 ORDER BY lokasi_nama ");
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h4 class="modal-title"><b>Data Kecamatan</b></h4>
        </div>
        <!-- body modal -->
...
<div id="myModal_input" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Tambah Data Kecamatan</b></h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
        <div class="col-xs-12" style="padding-bottom: 10px;">
  ...
  <div id="myModal_del" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><b>Hapus Data Kecamatan</b></h4>
        </div>
        <!-- body modal -->
        <div class="modal-body">
        <div class="col-xs-12" style="padding-bottom: 10px;">
...
<script type="text/javascript">
  function tampil() {
    ...
    var lokasi_kab = $('#data2').val();
    var tampung="";
    var indi = 'cari';
    var url_all = $('#url').val();
    var url = url_all+'kec/proses_kec.php';
    /*alert(lokasi_propinsi);*/
    //alert(lokasi_propinsi+','+lokasi_kab);

      $.getJSON(url, { lokasi_kab : lokasi_kab, kategori : kategori, kunci : kunci, lokasi_propinsi : lokasi_propinsi, indi : indi }, function(data) {
     //ambil data 
     var nomer = 1;
     var st ="";
     var warna = "#CCCCCC";
...
/* alert(st);*/
  ...
  var lokasi_propinsi = $('#cari').val();
    ...
    var lokasi_propinsi = $('#data').val();
    var lokasi_kab = $('#data2').val();
      $.getJSON(url, { lokasi_kab : lokasi_kab, lokasi_propinsi : lokasi_propinsi, indi : indi }, function(data) {
     //ambil data 
     var nomer = 1;
     var st ="";
     var warna = "#CCCCCC";
...
//alert(lokasi_propinsi+','+lokasi_kab);
 $.getJSON(url, { lokasi_kab : lokasi_kab, lokasi_propinsi : lokasi_propinsi, nama_data_in : nama_data_in, st_data_in : st_data_in, indi : indi }, function(data) {
