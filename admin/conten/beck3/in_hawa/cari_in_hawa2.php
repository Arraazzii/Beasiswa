...
<div class="table-responsive">
  ...
  <?php
    ...
    $result = mysql_query("SELECT a.nin, a.nama, a.tgl_la, a.kab, a.prov, b.nama_sekolah, b.kab, b.prov, a.email FROM data_pendaftar AS a, data_sekolah AS b WHERE a.nin = b.nin AND a.nin = '%".$nisn."%' AND a.nama LIKE '%".$nama."%' ");  
