...
//tujuan
$q = mysql_query("SELECT nin,email FROM data_pendaftar WHERE st_admis = 'Y' AND st_wawan = 'Y' AND YEAR(tgl_daftar) = '$tahun' AND no_beasiswa = '$nomer'");
...
<?php  } else { 
 $qry="INSERT INTO `pengumuman_beasiswa` (`no_beasiswa`, `tahun`, `judul`, `tgl`, `file`) VALUES ('$nomer', '$tahun', '$judul', '$tgl', '$file_name')";
