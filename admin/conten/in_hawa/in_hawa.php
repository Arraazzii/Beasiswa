...
<div class="col-md-4 col-lg-4" >
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right" height="50px"> <input style="height:35px; float:right; margin-top:5px;" type="submit" value="Cari" class="btn btn-warning"></td>
  </tr>
</table>
   </td>
  </tr>
...
<div class="table-responsive">
  ...
  <?php
 	$i=1;
    $result = mysql_query("SELECT a.nin, a.nama, a.tgl_la, a.kab, a.prov, b.nama_sekolah, b.kab, b.prov, a.email FROM data_pendaftar AS a, data_sekolah AS b WHERE a.nin = b.nin ANd a.st_admis = 'Y' AND a.st_wawan = 'N' ");
...
{  
    ...
    <td bgcolor=\"$bg\">$row[2]</td>
    <td bgcolor=\"$bg\">$row[3]</td>
    <td bgcolor=\"$bg\">$row[4]</td>
    <td bgcolor=\"$bg\">$row[5]</td>
    <td bgcolor=\"$bg\">$row[6]</td>
    <td bgcolor=\"$bg\">$row[7]</td>
    <td bgcolor=\"$bg\">$row[8]</td>
	<td bgcolor=\"$bg\"> <button type=\"button\" class=\"btn btn-info btn-lg\" data-toggle=\"modal\" data-target=\"#myModal\" onclick=\"wawan($(this))\">Wawancara</button>
  </td>
  </tr>";	
  $i++;	
}
