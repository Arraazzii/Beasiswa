...
$query="UPDATE info_beasiswa SET no_beasiswa='$no_bea', nama_beasiswa='$nama_bea', tahun='$tahun_beasiswa', jenjang='$jenis_bea', total_dana='$total_dana_bea', jumlah_beasiswa='$jumlah_bea', keterangan='$ket_bea' 
where no_beasiswa = '$id'
";
mysql_query($query);
...
$query1="UPDATE jadwal_beasiswa SET no_beasiswa='$no_bea',pengumuman='$pengu_beasiswa', spd1='$wtf1',
...
UPDATE nilai_minimum SET no_beasiswa = '$no_bea', seleksi_wawancara = '$batas_lulus_wawancara', seleksi_admin = '$bts_lulus'
where no_beasiswa = '$id'");
...
UPDATE admis_nilai_raport SET no_beasiswa = '$no_bea', 
index0='$nr_index0',
spd0='$nr_spd0',
index1='$nr_index1',
spd1='$nr_spd1',
...
UPDATE jpa_lokal SET no_beasiswa = '$no_bea', 
index0='$jpalo_index0',
spd0='$jpalo_spd0',
index1='$jpalo_index1',
spd1='$jpalo_spd1',
...
UPDATE jpa_daerah SET no_beasiswa = '$no_bea', 
...
UPDATE jpa_nas SET no_beasiswa = '$no_bea', 
...
UPDATE jpa_inter SET no_beasiswa = '$no_bea', 
...
UPDATE jpna_lokal SET no_beasiswa = '$no_bea', 
...
UPDATE jpna_daerah SET no_beasiswa = '$no_bea', 
...
UPDATE jpna_nas SET no_beasiswa = '$no_bea', 
...
UPDATE jpna_inter SET no_beasiswa = '$no_bea', 
...
UPDATE admis_nilai_ipk SET no_beasiswa = '$no_bea', 
index0='$ni_index0',
spd0='$ni_spd0',
index1='$ni_index1',
spd1='$ni_spd1',
...
UPDATE tingkat_pres_akademis SET no_beasiswa = '$no_bea', 
index0='$tpa_index0',
...
UPDATE tingkat_presnon_akademis SET no_beasiswa = '$no_bea', 
index0='$tpna_index0',
...
UPDATE wawan_nilkat1 SET no_beasiswa = '$no_bea', 
index0='$kt1_index0',
spd0='$kt1_spd0',
index1='$kt1_index1',
spd1='$kt1_spd1',
...
UPDATE wawan_nilkat2 SET no_beasiswa = '$no_bea', 
index0='$kt2_index0',
spd0='$kt2_spd0',
index1='$kt2_index1',
spd1='$kt2_spd1',
...
UPDATE wawan_nilkat3 SET no_beasiswa = '$no_bea', 
index0='$kt3_index0',
spd0='$kt3_spd0',
index1='$kt3_index1',
spd1='$kt3_spd1',
...
UPDATE wawan_nilkat4 SET no_beasiswa = '$no_bea', 
index0='$kt4_index0',
spd0='$kt4_spd0',
index1='$kt4_index1',
spd1='$kt4_spd1',
...
UPDATE wawan_nilkat5 SET no_beasiswa = '$no_bea', 
index0='$kt5_index0',
spd0='$kt5_spd0',
index1='$kt5_index1',
spd1='$kt5_spd1',
...
UPDATE wawan_nilkat6 SET no_beasiswa = '$no_bea', 
index0='$kt6_index0',
spd0='$kt6_spd0',
index1='$kt6_index1',
spd1='$kt6_spd1',
