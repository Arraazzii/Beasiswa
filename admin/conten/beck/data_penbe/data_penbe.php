...
<center><h3>Data Penerima Beasisiwa</h3>
  <p>&nbsp;</p>
</center>
<hr>
<div class="col-md-5 col-lg-5" >
  ...
  <tr>
    <td>Tahun</td>
    <td >
    <select nama="tahun" id="tahun" style="width:100%;" >
  ...
  <tr>
    <td width="180"></td>
    <td align="right"><button type="button" class="btn btn-warning" style="height:35px; margin-top:5px;" onclick="cari()"><span class=" glyphicon glyphicon-search"></span> &nbsp;&nbsp;&nbsp;Cari&nbsp;&nbsp;&nbsp;</button>&nbsp;&nbsp;<button type="button" class="btn btn-warning" style="height:35px  margin-top:5px;" onclick="cari()"> &nbsp;&nbsp;&nbsp;Batal&nbsp;&nbsp;&nbsp;</button> </td>
  </tr>
</table>
   </td>
  </tr>
