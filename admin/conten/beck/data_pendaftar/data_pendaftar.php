  ...
  <tr>
    ...
    <td width="22%">
      <select name="id_daf" id="id_daf" style="width:100%;">
        <?php
          $result_nomer = mysql_query("SELECT DISTINCT  nin FROM data_pendaftar WHERE st_admis = 'N'");  
...
FROM
data_pendaftar WHERE st_admis = 'N'");  
          while ($row_nomer = mysql_fetch_array($result_nomer))  
          {
            echo"<option value='$row_nomer[0]'>$row_nomer[0]</option>";
          }  
 ...
 echo " <tr style='background-color: #FFFFFF'>
   ...
   <tr><td></td></tr>
    ...
    <td colspan="9"></td>
       ...
       <form action="data_pendaftar/pendaftaran_export_excel_all.php" method="post">
